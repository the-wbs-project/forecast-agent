...
using WeatherGuard.Api.Models;

namespace WeatherGuard.Api.Services;
...
public class DatadogService : IDisposable
{
    ...
    {
        _config = config;
        timer = new Timer(Flush, null, 0, 5000); // 5 seconds
    }
        ...
        Exception exception)
    {
        ...
        logs.Add(new DatadogLog
        {
            ...
            ddtags = $"env:{_config.LogEnvironment},app:weather-guard",
