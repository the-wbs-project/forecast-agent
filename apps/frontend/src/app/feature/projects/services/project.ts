...
import type { ApiResponse, PagedResult } from "../../../shared/models";
import type {
...
export class ProjectService {
	...
	async getProjects(
		...
		try {
			...
			const response = await firstValueFrom(
				this.http.get<ApiResponse<PagedResult<Project>>>(this.apiUrl, {
					params,
				}),
			);
	...
	async updateProject(
		...
		try {
			const response = await this.http
				.put<ApiResponse<Project>>(`${this.apiUrl}/${id}`, project)
				.toPromise();
	...
	async importProject(
		...
		try {
			...
			const response = await this.http
				.post<ApiResponse<Project>>(`${this.apiUrl}/import`, formData)
				.toPromise();
	...
	async getProjectSchedules(projectId: string): Promise<ProjectSchedule[]> {
		...
		try {
			const response = await this.http
				.get<ApiResponse<ProjectSchedule[]>>(
